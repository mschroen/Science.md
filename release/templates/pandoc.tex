...
%%% MARTIN
    ...
    $for(comments)$
    \def\$comments.ini$#1\par{\setlength{\fboxsep}{1pt}\colorbox{$comments.col$}{\textcolor{white}{\texttt{$comments.ini$}}} \color{$comments.col$} #1\color{black}}
    $endfor$
...
%%% MARTIN
    ...
    \vspace*{1em}
    Keywords: $for(keypoints)$ $keypoints$, $endfor$
%%%
\end{abstract}
$endif$
